...
### App Stores
- [Google Play Store](https://play.google.com/) - Despite [misinformation](https://privsec.dev/posts/android/f-droid-security-issues/), the Play Store is the easiest and safest way for most users to obtain apps. GrapheneOS includes a mirror in their [app repository](https://grapheneos.org/features#grapheneos-app-repository) for users to obtain safely
...
- [Obtainium](https://github.com/ImranR98/Obtainium/releases/latest) - Obtainium isn't an app store in itself but rather an app that lets you get Android app updates directly from the source. This doesn't come without it's risks so [AppVerifier](https://github.com/soupslurpr/appverifier) is a useful app for verifying signatures of apps
